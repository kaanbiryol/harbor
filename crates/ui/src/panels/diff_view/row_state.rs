    ...
    pub(super) fn from_view(view: &'a AppView, cx: &App, view_entity: Entity<AppView>) -> Self {
        Self {
            ...
            review_thread_reply_body_empty: view
                ...
                .trim()
                .is_empty(),
            is_submitting_review_thread_reply: view.is_submitting_review_thread_reply,
            ...
            review_comment_edit_body_empty: view
                ...
                .trim()
                .is_empty(),
            is_submitting_review_comment_edit: view.is_submitting_review_comment_edit,
            review_comment_edit_error: view.review_comment_edit_error.as_ref(),
            review_comment_action_comment_id: view.review_comment_action_comment_id.as_deref(),
            review_comment_action_error: view.review_comment_action_error.as_ref(),
