use gpui::{
    Anchor, App, Context, FocusHandle, Focusable, IntoElement, Render, Window, div, prelude::*, px,
    rgb, uniform_list,
};
use gpui_component::{
...
pub(crate) use header::open_with_app_disabled;
use header::{
    handle_pull_request_switcher_key, handle_repository_switcher_key, open_with_action,
    open_with_icon, render_switcher_empty_row, render_switcher_error_row,
    render_switcher_loading_row, render_switcher_pull_request_row, render_switcher_repository_row,
