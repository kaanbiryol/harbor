...
pub(super) const LOCAL_REVIEW_THREAD_ID_PREFIX: &str = "local-review-thread-";
pub(super) const LOCAL_REVIEW_COMMENT_ID_PREFIX: &str = "local-review-comment-";
...
pub(super) struct ReviewReactionKey {
    comment_id: String,
    content: ReactionContent,
}

impl ReviewReactionKey {
    pub(super) fn new(comment_id: impl Into<String>, content: ReactionContent) -> Self {
        Self {
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(super) struct OptimisticReviewCommentHandle {
...
pub(super) fn pending_review_from_reviews(
...
pub(super) fn apply_review_thread_state_overrides(
...
pub(super) fn apply_review_reaction_overrides(
    review_threads: &mut [ReviewThread],
...
pub(super) fn set_review_comment_reaction_state(
...
pub(super) fn merge_optimistic_review_threads(
...
pub(super) fn remove_review_comment_from_threads(
...
pub(super) fn unresolved_review_thread_count(threads: &[ReviewThread]) -> usize {
    threads
        .iter()
...
pub(super) fn increment_pending_review_comment_count(
...
pub(super) fn rollback_pending_review_comment_count(
    pending_review: &mut Option<PendingReviewSession>,
...
pub(super) fn is_local_review_thread_id(thread_id: &str) -> bool {
...
pub(super) fn review_position_from_range(range: &ReviewCommentRange) -> ReviewCommentPosition {
